                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="tf-heading mb60 wow fadeInUp">
                            <h2 className="heading">ROAD MAP22</h2>
                        </div>
                                    ...
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                            ...
                                            <div className="roadmap-box">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <ul className="list-infor">
                                                        ...
                                                        <li>
                                                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} viewBox="0 0 16 18" fill="none">
                                                                <g clipPath="url(#clip0_2346_6159)">
                                                        ...
                                                        <li>
                                                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} viewBox="0 0 16 18" fill="none">
                                                                <g clipPath="url(#clip0_2346_6160)">
                                        ...
                                        <SwiperSlide>
                                            <div className="roadmap-box">
                                                ...
                                                <div className="content">
                                                    <h4 className="title">PHASE 7</h4>
                                                    <ul className="list-infor">
                                                        <li>
                                                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} viewBox="0 0 16 18" fill="none">
                                                                <g clipPath="url(#clip0_2346_6161)">
                                                        ...
                                                        <li>
                                                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} viewBox="0 0 16 18" fill="none">
                                                                <g clipPath="url(#clip0_2346_6162)">
