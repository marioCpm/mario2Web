...
import PartnerSlider3 from "../slider/PartnerSlider3"


export default function Partner1({StackData}) {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-md-12 ">
                            <div className="tf-heading mb60  fadeInUp">
                                <h2 className="heading"><span>GALENAI</span> STACK</h2>
                            </div>
                        </div>
                        <div className="col-md-12  fadeInUp">
                            <div className="swiper-container partner ">
                                <PartnerSlider1 stack={StackData?.stack1}/>
                            </div>
                        </div>
                        <div className="col-md-12 ">
                            <div className="swiper-container partner-2 style-2">
                                <PartnerSlider2 stack={StackData?.stack2}/>
                            </div>
                        </div>
                        <div className="col-md-12 ">
                            <div className="swiper-container partner ">
                                <PartnerSlider3 stack={StackData?.stack3}/>
                            </div>
                        </div>
                    </div>
                </div>
